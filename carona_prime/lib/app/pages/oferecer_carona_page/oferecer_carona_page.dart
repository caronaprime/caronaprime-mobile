...
class OferecerCaronaPage extends StatefulWidget {
  final GlobalKey<ScaffoldState> scaffoldKey;
  final int grupoId;
  OferecerCaronaPage({@required this.scaffoldKey, @required this.grupoId});

  @override
  _OferecerCaronaPageState createState() => _OferecerCaronaPageState();
}

class _OferecerCaronaPageState extends State<OferecerCaronaPage> {
  @override
  void initState() {
    _controller.carregarOfertaCarona(widget.grupoId);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Observer(
        builder: (_) => !_controller.carregou
            ? Center(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                          ...
                          children: <Widget>[
                            Observer(
                              builder: (_) => opcaoAdicionalButton(
                                  ...
                                  onTap: () => _controller.setCarroAdaptado(
                                      !_controller.carroAdaptado)),
                            ),
                            Observer(
                                builder: (_) => opcaoAdicionalButton(
                                      "Porta-malas livre",
                                      ...
                                      onTap: () =>
                                          _controller.setPortaMalasLivre(
                          ...
                          children: <Widget>[
                            ...
                            Observer(
                                builder: (_) => DropdownButton(
                                      ...
                                      onChanged:
                                          _controller.setVagasDisponiveis,
                        ...
                        Container(
                          ...
                          child: DateTimeField(
                              initialValue:
                                  DateTimeField.convert(_controller.hora),
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: RaisedButton(
                              ...
                              onPressed: () async {
                                var sucesso = await _controller
                                    .compartilharCarona(widget.grupoId);
                                if (sucesso) {
